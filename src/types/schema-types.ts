...
export type GetAllBillsForSessionQuery = {
  __typename?: "Query";
  bills?:
    | Array<{
        __typename?: "IBill";
 ...
 * });
 */
export function useGetAllBillsForSessionQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAllBillsForSessionQuery,
    GetAllBillsForSessionQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetAllBillsForSessionQuery, GetAllBillsForSessionQueryVariables>(
    GetAllBillsForSessionDocument,
    options,
  );
}
export function useGetAllBillsForSessionLazyQuery(
  ...
  return Apollo.useLazyQuery<
    GetAllBillsForSessionQuery,
    GetAllBillsForSessionQueryVariables
  >(GetAllBillsForSessionDocument, options);
}
export type GetAllBillsForSessionQueryHookResult = ReturnType<
  typeof useGetAllBillsForSessionQuery
>;
export type GetAllBillsForSessionLazyQueryHookResult = ReturnType<
  typeof useGetAllBillsForSessionLazyQuery
>;
export type GetAllBillsForSessionQueryResult = Apollo.QueryResult<
  GetAllBillsForSessionQuery,
  GetAllBillsForSessionQueryVariables
>;
